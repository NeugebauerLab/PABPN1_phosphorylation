...
file <- "/home/jmg292/palmer_scratch/Exp31/bamtobakr/results/cB/cB.csv.gz"
...
write_delim(Fit_s$Fast_Fit$Effects_df, "/home/jmg292/palmer_scratch/Exp31/12142023_Fit_effects_DF_all.csv")
write_delim(Fit_s$Fast_Fit$Fn_Estimates, "/home/jmg292/palmer_scratch/Exp31/12142023_Fit_Fn_Estimates_all.csv")
write_delim(Fit_s$Fast_Fit$Regularized_ests, "/home/jmg292/palmer_scratch/Exp31/12142023_Fit_Regularized_ests_all.csv")
...
#Save dataframes for making figures in python
write_delim(Fit_s$Fast_Fit$Effects_df, "/home/jmg292/palmer_scratch/Exp31/12142023_Fit_effects_DF_4SA_4SD.csv")
write_delim(Fit_s$Fast_Fit$Fn_Estimates, "/home/jmg292/palmer_scratch/Exp31/12142023_Fit_Fn_Estimates_4SA_4SD.csv")
write_delim(Fit_s$Fast_Fit$Regularized_ests, "/home/jmg292/palmer_scratch/Exp31/12142023_Fit_Regularized_ests_4SA_4SD.csv")
...
DE_df <- DE_df %>%
  mutate(conclusion = as.factor(ifelse(DE_padj < 0.01, 
                                       ...
                                       "Not sig.")))
DE_df
write_delim(DE_df, "/home/jmg292/palmer_scratch/Exp31/12042023_DE_df_4SA_4SD.csv")
...
write_delim(ksyn_df, "/home/jmg292/palmer_scratch/Exp31/12042023_ksyn_df_4SA_4SD.csv")
